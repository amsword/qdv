...
def check_mapping(request):
    ...
    if request.method == 'POST':
        return HttpResponse(json.dumps({'message': 'good'}))
    else:
        return render(request, 'detection/category_viewer.html')
        #return serve_file(op.join(get_qd_root(),
            #'data/Tax4k_V1_6/category_viewer3/index.html'))
